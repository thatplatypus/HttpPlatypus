...
<div class="container mx-auto px-4 py-8">
  ...
  <div class="mb-6 w-full">
    ...
    >
      <ToggleGroup.Item
        value="1xx"
        aria-label="Filter 1xx status codes"
        class="flex-1 data-[state=on]:bg-blue-100 data-[state=on]:dark:bg-blue-900/30 data-[state=on]:text-blue-900 data-[state=on]:dark:text-blue-100"
      >
        <span class="px-2">1xx</span>
      </ToggleGroup.Item>
      <ToggleGroup.Item
        value="2xx"
        aria-label="Filter 2xx status codes"
        class="flex-1 data-[state=on]:bg-green-100 data-[state=on]:dark:bg-green-900/30 data-[state=on]:text-green-900 data-[state=on]:dark:text-green-100"
      >
        <span class="px-2">2xx</span>
      </ToggleGroup.Item>
      <ToggleGroup.Item
        value="3xx"
        aria-label="Filter 3xx status codes"
        class="flex-1 data-[state=on]:bg-yellow-100 data-[state=on]:dark:bg-yellow-900/30 data-[state=on]:text-yellow-900 data-[state=on]:dark:text-yellow-100"
      >
        <span class="px-2">3xx</span>
      </ToggleGroup.Item>
      <ToggleGroup.Item
        value="4xx"
        aria-label="Filter 4xx status codes"
        class="flex-1 data-[state=on]:bg-red-100 data-[state=on]:dark:bg-red-900/30 data-[state=on]:text-red-900 data-[state=on]:dark:text-red-100"
      >
        <span class="px-2">4xx</span>
      </ToggleGroup.Item>
      <ToggleGroup.Item
        value="5xx"
        aria-label="Filter 5xx status codes"
        class="flex-1 data-[state=on]:bg-purple-100 data-[state=on]:dark:bg-purple-900/30 data-[state=on]:text-purple-900 data-[state=on]:dark:text-purple-100"
      >
